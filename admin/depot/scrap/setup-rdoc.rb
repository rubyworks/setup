...
#ROOT_DIRECTORY = File.dirname(File.expand_path($0))
...
RDOC_ADFILE = 'site/ads/rdoc.html'
...
class ToplevelInstaller
  ...
  def parsearg_no_options
    unless ARGV.empty?
      task = caller(0).first.slice(%r<`parsearg_(\w+)'>, 1)   #` This is here for editer poor sake.
