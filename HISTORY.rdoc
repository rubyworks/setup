...
project for more details. One can still use .setup/name, .setup/version, .setup/loadpath
files instead.


== 5.1.1 / 2012-03-21

Qucik fix to update the bundled version of setup.rb.

Changes:

* Update bundled script.rb.
